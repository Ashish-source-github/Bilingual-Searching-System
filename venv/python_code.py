...
f = open(DEVELOPMENT_DOCS,errors='ignore')
...
f = open(BITEXT_ENG,errors = 'ignore')
...
f = open(BITEXT_DE, errors='ignore')
for line in f:
    terms = tokenize(line)
...
eng_de_m = IBMModel2(eng_de_bt, 5)
...
de_eng_m = IBMModel2(de_eng_bt, 5)
...
f = open(DEVELOPMENT_QUERIES,errors='ignore')
